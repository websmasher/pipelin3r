...
This project is indexed by GitNexus as **pipelin3r** (935 symbols, 2088 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
