...
use domain_types::{RetryConfig, SchedulrError};
...
/// fail, returns [`SchedulrError::RetryExhausted`].
#[derive(Debug)]
...
impl repo::RetryExecutor for TokioRetryExecutor {
            ...
            match result {
                ...
                Err(err) => {
                    ...
                    if attempt >= config.max_attempts {
                        ...
                        return Err(SchedulrError::RetryExhausted {
                            attempts: config.max_attempts,
                        });
                    }
